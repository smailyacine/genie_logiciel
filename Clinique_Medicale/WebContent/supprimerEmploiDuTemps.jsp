  ...
  if(year.options[year.selectedIndex].value == "1" || month.options[month.selectedIndex].value == "1" | day.options[day.selectedIndex].value == "1"){
		...
		var ddate = day.options[day.selectedIndex].value;
		 var xhttp; 
		  ...
		  xhttp.open("GET", "http://localhost:8080/Clinique_Medicale/supprimerCreneau?date="+ysate+"-"+mdate+"-"+ddate, true);
		  xhttp.send();
	}
}
function loadjsp(){
	var creneau = document.getElementById("CreneauxAsupprimer");
	creneau.style.visibility = 'visible';
	$("#CreneauxAsupprimer").load("creneauAsupprimer.jsp");
}
...
<div class= "select_prendre_rdv">
	...
	<div id="CreneauxAsupprimer" style="visibility: hidden"></div>
</body>
</html>