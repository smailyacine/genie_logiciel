...
public class VoireRdv extends HttpServlet {
	...
	private String resultat_voireMesRdv;
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Rdv> MesRdv = new ArrayList<Rdv>();
		try{
		MesRdv = rdvDao.trouverRdv(patient.getNum_assurance());
		if(MesRdv == null ){
			resultat_voireMesRdv = "Désolé, aucun rendez-vous n'a été enregistré pour cette nom !!!";
		}else{
			resultat_voireMesRdv = "Liste des rendez-vous :";
			
		}
		}catch( DAOException e ) {
			resultat_voireMesRdv= "Échec lors de la récuperation de vos rendez-vous : une erreur imprévue est survenue, merci de réessayer dans quelques instants.";
			e.printStackTrace();
		}
		session.setAttribute(ATT_SESSION_LISTE_RDV, MesRdv);
