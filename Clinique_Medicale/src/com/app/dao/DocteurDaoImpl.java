...
/* Récupération d'une connexion depuis la Factory */
connexion = daoFactory.getConnection();
preparedStatement = initialisationRequetePreparee( connexion,SQL_INSERT, true, docteur.getIdentifiant(),docteur.getNom(),docteur.getPrenom(), docteur.getAdresse(),docteur.getTelephone(),docteur.getEmail(),docteur.getMotDePasse());
